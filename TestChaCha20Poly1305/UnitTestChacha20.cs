...
internal class UnitTestChacha20
{
  ...
  {
    Console.WriteLine($"{nameof(UnitTestChacha20)}");
    Console.WriteLine($"****************");
    Console.WriteLine();
  ...
  private static void Test_Instance(int rounds)
  {
    ...
    for (var i = 0; i < rounds; i++)
    {
      ...
      using var cc201 = new ChaCha20(key, iv);
      var cipher = cc201.Encryption(plain);
    ...
    for (var i = 0; i < rounds; i++)
    {
      ...
      //with the cipher.
      using var cc201 = new ChaCha20(key);
      var cipher = cc201.Encryption(plain);
  ...
  private static void Test_Continue(int rounds)
  {
    ...
    //Die gleiche ChaCha20-Instanz wird über eine sehr
    //lange Strecke genutzt. Der CurrentBlock wird immer 
    //um 1 hochgezählt.
    ...
    for (var i = 0; i < rounds; i++)
    {
      ...
      //All cipher have the same iv, but not
