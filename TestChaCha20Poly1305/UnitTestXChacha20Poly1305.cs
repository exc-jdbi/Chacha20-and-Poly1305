...
internal class UnitTestXChacha20Poly1305
{
  ...
  private static void Test_Instance(int rounds)
  {
    ...
    for (var i = 0; i < rounds; i++)
    {
      ...
      //with the cipher.
      using var cc201 = new XChaCha20Poly1305Ex(key);
      var cipher = cc201.Encryption(plain, aad);

      using var cc202 = new XChaCha20Poly1305Ex(key);
  ...
  private static void Test_Continue(int rounds)
  {
    ...
    //The iv (nonce) is fully utilized in HChacha20 over a distance of 2^64,
    //which corresponds to an encryption distance in XChacha20Poly1305
    //of 64 * 2^64 = 2^70.
    var start = 0;
    var key = RngBytes(32);
  ...
  private static void Test_Instance_Stream(int rounds)
  {
    ...
    for (var i = 0; i < rounds; i++)
    {
      ...
      //An IV is supplied here.
      using var cc201 = new XChaCha20Poly1305Ex(key, iv);
      var cipher = cc201.Encryption(plain, aad);
